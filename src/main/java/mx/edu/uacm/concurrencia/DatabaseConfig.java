...
public class DatabaseConfig {
	...
	/*
	 * En una relacion muchoa a muchos, existen atributos que no encagan en ninguna de las dos entidades, 
	 * ese atributo puede ser parte de la relacion lo primerop que se tiene que hacer es crear una relacion 
	 * con el nombre de la asociacion 
	 * 2. crear una pk_compuesta que es una clase, que asocia a la per con la direccion, 
	 */
